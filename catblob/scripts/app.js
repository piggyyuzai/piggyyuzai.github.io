059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069,
        1070, 1071, 1072, 1073, 1074, 1075, 1076, 1086, 1089, 1092, 1094, 1095,
        1098, 1104, 1111, 1112, 1114, 1115, 1126, 1129, 1132, 1133, 1134, 1135,
        1136, 1137, 1138, 1144, 1151, 1155, 1166, 1169, 1172, 1175, 1176, 1178,
        1184, 1191, 1195, 1206, 1209, 1210, 1211, 1212, 1215, 1216, 1217, 1218,
        1219, 1220, 1221, 1222, 1223, 1224, 1225, 1226, 1227, 1228, 1229, 1230,
        1231, 1235, 1246, 1249, 1260, 1264, 1267, 1271, 1275, 1286, 1289, 1300,
        1304, 1307, 1311, 1315, 1324, 1325, 1326, 1327, 1328, 1329, 1330, 1331,
        1332, 1333, 1334, 1335, 1336, 1337, 1338, 1339, 1340, 1341, 1342, 1343,
        1344, 1347, 1351, 1355, 1364, 1366, 1369, 1370, 1371, 1384, 1387, 1391,
        1395, 1404, 1405, 1406, 1410, 1411, 1424, 1425, 1426, 1427, 1428, 1429,
        1430, 1432, 1433, 1434, 1449, 1467,
      ],
    },
    {
      itemName: "big star",
    ...
    },
    {
      ...
      cellsWithItem: [
        180, 231, 286, 484, 496, 506, 608, 695, 701, 754, 849, 911, 935, 938,
        1113, 1177, 1409, 1431,
      ],
    },
  ];
  ...
  function setActorPosition(actor) {
    // resets horizontal and vertical position of cpu or player
  ...
  function resetCpuSpeed(cpu) {
    ...
    cpu.motionInterval = setInterval(function () {
  ...
  function triggerGameStart() {
    if (!gameStartCover.classList.contains("display")) {
      // prevents start button being pressed again once game is already in play
      return;
    }
    ...
    setInterval(() => {
      //* readjusts actor display sizes incase player resizes window
  ...
  function countDown() {
    // count down circle animation when game starts and resets
  ...
  function checkPlayerAndCpuCollision() {
    if (
      !player.display.classList.contains("hidden") &&
      !player.display.classList.contains("flicker")
    ) {
      cpuObjects.forEach((cpu) => {
        if (
          player.position === cpu.position &&
          player.display.classList.contains("invincible") &&
          cpu.status !== "inactive"
        ) {
          knockOutCpu(cpu);
        } else if (
  ...
  function rePositionImage(target) {
    target.display.style.top = `${
      cells[target.position].getBoundingClientRect().y
    }px`;
    target.display.style.left = `${
      cells[target.position].getBoundingClientRect().x
    }px`;
  }
  ...
  function rePositionAllActorImages() {
    ...
    cpuObjects.forEach((cpu) => {
      if (cpu.status === "inactive" || gameStatus === "pause") {
        cpu.display.style.top = `${
          cells[cpu.position].getBoundingClientRect().y
        }px`;
        cpu.display.style.left = `${
          cells[cpu.position].getBoundingClientRect().x
        }px`;
      }
    });
  }
  ...
  function knockOutCpu(cpu) {
    ...
    setTimeout(() => {
      cpu.knockOutAnimationDisplay.style.top = `${
        scoreDisplay.getBoundingClientRect().y
      }px`;
      cpu.knockOutAnimationDisplay.style.left = `${
        scoreDisplay.getBoundingClientRect().x
      }px`;
    }, 800);
    ...
    cpu.recoveryInterval = setInterval(function () {
  ...
  function changeStatusToActive(cpu) {
    if (itemToCollect > 0 && !cpu.display.classList.contains("fadein")) {
      //* this added to ensure cpus do not recover when game is already complete, and also prevents controlCpu's activate actions.
      cpu.status = "active";
    }
  }

  function animateSparkle(cpu) {
    //this is the sparkle that appears when cpu is defeated
    cpu.knockOutAnimationDisplay = document.createElement("div");
    cpu.knockOutAnimationDisplay.classList.add("effect_animation_slow");
    cpu.knockOutAnimationDisplay.innerHTML =
      '<img src = "./assets/sparkle.gif" ></img>';
    ...
    setTimeout(function () {
      cpu.knockOutAnimationDisplay.style.top = `${
        outerCells[cpu.defaultPosition].getBoundingClientRect().y
      }px`;
      cpu.knockOutAnimationDisplay.style.left = `${
        outerCells[cpu.defaultPosition].getBoundingClientRect().x
      }px`;
    }, 100);
  ...
  function displayKnockOutAnimation(actor) {
    ...
    actor.knockOutAnimationDisplay.style.top = `${
      actorCurrentPosition.y - (knockOutCpuCounter - 1) * 10
    }px`;
    actor.knockOutAnimationDisplay.style.left = `${actorCurrentPosition.x}px`;

    actor.knockOutAnimationDisplay.style.height = `${
      cells[0].getBoundingClientRect().height
    }px`;
    actor.knockOutAnimationDisplay.style.width = `${
  ...
  function bringBackPlayerToPlay() {
    setTimeout(function () {
      player.knockOutAnimationDisplay.style.top = `${
        cells[player.position % 40].getBoundingClientRect().y
      }px`; // reposition hurt animation to top of screen (same row where playerLoseLife triggered)
    }, 800);
    ...
    setTimeout(function () {
      ...
      const lifeCounterPosition =
        lifeCounters[lifeCounters.length - 1].getBoundingClientRect();
      ...
      setTimeout(function () {
        // move player life image to where the player was
  ...
  function resetGame() {
    ...
    if (!gameEndCover.classList.contains("shade")) {
      // prevents unwanted resets when reset button is accidentally pressed by space bar
      return;
    }
    ...
    setTimeout(() => {
      ...
      cpuObjects.forEach((cpu) => {
        // remove old position before reinitialising
        removeActor(cpu);
        cpu.moodTimer = 0;
        clearInterval(cpu.recoveryInterval);
        cpu.recoveryTimer = 0;
  ...
  function displayActorImage(actor) {
    ...
    if (actor !== player) {
      //* syncing actor's speed with it's speed (only for cpu)
      actor.display.style.transition = `${actor.speed / 1000}s`;
    }
    if (actor !== player && actor.speed >= 300) {
      //* ensure transition is atleast 0.3 however slow
  ...
  function changeActorImageAndMoveToNewPosition(actor) {
    if (
      actor === player &&
      (actor.facingDirection === "left" || actor.facingDirection === "right")
    ) {
    ...
    actor.display.style.top = `${
      cells[actor.position].getBoundingClientRect().y
    }px`;
    actor.display.style.left = `${
      cells[actor.position].getBoundingClientRect().x
    }px`;
  ...
  function cpuDetermineTarget(cpu) {
    ...
    cpu.target = [
      cpu.defaultTarget.horizontalPosition,
      cpu.defaultTarget.verticalPosition,
    ];
  ...
  function isElementInFacingDirection(actor, ele) {
    switch (actor.facingDirection) {
      case "right":
        return (
          outerCells[actor.position + 1].classList.contains(ele) ||
          cells[actor.position + 1].classList.contains(ele)
        );
      case "left":
        return (
          outerCells[actor.position - 1].classList.contains(ele) ||
      ...
      case "up":
        return (
          outerCells[actor.position - width].classList.contains(ele) ||
          cells[actor.position - width].classList.contains(ele)
        );
      case "down":
        return (
          outerCells[actor.position + width].classList.contains(ele) ||
  ...
  function cpuMovementDecision(cpu) {
    ...
    if (
      cpu.facingDirection === "right" &&
      !isElementInFacingDirection(cpu, "wall")
    ) {
      cpu.motion = ["right"];
    }
    if (
      cpu.facingDirection === "left" &&
      !isElementInFacingDirection(cpu, "wall")
    ) {
      cpu.motion = ["left"];
    }
    if (
      cpu.facingDirection === "down" &&
      !isElementInFacingDirection(cpu, "wall")
    ) {
      cpu.motion = ["down"];
    }
    if (
      cpu.facingDirection === "up" &&
      !isElementInFacingDirection(cpu, "wall")
    ) {
      cpu.motion = ["up"];
    }
    ...
    if (
      cpu.facingDirection === "down" &&
      isElementInFacingDirection(cpu, "boundary")
    ) {
      // when facing down and boundary is below
    ...
    if (
      (cpu.facingDirection === "down" &&
        isElementInFacingDirection(cpu, "wall")) ||
      (cpu.facingDirection === "up" && isElementInFacingDirection(cpu, "wall"))
    ) {
      cpu.motion = ["left", "right"];
    }

    //! below possibly not necessary, but maybe useful when running away from player?
    if (isElementAbove(cpu, "wall") && isElementOnRightOf(cpu, "wall")) {
      // when wall at top and right
      cpu.motion = ["down", "left"];
    }
    if (isElementAbove(cpu, "wall") && isElementOnLeftOf(cpu, "wall")) {
      // when wall at top and left
      cpu.motion = ["right", "down"];
    }
    if (isElementBelow(cpu, "wall") && isElementOnRightOf(cpu, "wall")) {
      // when wall at bottom and right
      cpu.motion = ["up", "left"];
    }
    if (isElementBelow(cpu, "wall") && isElementOnLeftOf(cpu, "wall")) {
  ...
  function avoidTarget(cpu) {
    ...
    if (
      cpu.position + 1 === player.position ||
      cpu.position + 2 === player.position ||
      cpu.position + 3 === player.position ||
      cpu.position + 1 - width === player.position ||
      cpu.position + 1 + width === player.position
    ) {
    ...
    if (
      cpu.position - width === player.position ||
      cpu.position - width * 2 === player.position ||
      cpu.position - width * 3 === player.position ||
      cpu.position - width - 1 === player.position ||
      cpu.position - width + 1 === player.position
    ) {
      cpu.filteredMotion = cpu.motion.filter((option) => {
        return option !== "up";
  ...
  function cpuMovement(cpu) {
    ...
    switch (cpu.motion[motionIndex]) {
      case "right":
        if (
          cpu.horizontalPosition < width - 1 &&
          !isElementOnRightOf(cpu, "wall")
        )
          cpu.position++;
        break;
      case "left":
        if (cpu.horizontalPosition > 0 && !isElementOnLeftOf(cpu, "wall"))
          cpu.position--;
        break;
      case "up":
        if (cpu.verticalPosition > 0 && !isElementAbove(cpu, "wall"))
          cpu.position -= width;
        break;
      case "down":
        if (
          cpu.verticalPosition < height - 1 &&
          !isElementBelow(cpu, "wall") &&
          !isElementBelow(cpu, "boundary")
        )
          cpu.position += width;
        break;
      default:
  ...
  function takeItemAndEarnScore(itemObject) {
    if (player.display.classList.contains("flicker")) {
      // prevents player taking item when in flicker state
      return;
    }
    ...
    if (outerCells[player.position].classList.contains(itemObject.class)) {
      ...
      const currentPlayerPosition =
        outerCells[player.position].getBoundingClientRect();
  ...
  function teleport(actor) {
    ...
    actor.position =
      cellsWithTeleportExit[cellsWithTeleport.indexOf(actor.position)];
    addActor(actor);
  ...
  function handleMovement(e) {
    if (
      player.display.classList.contains("hidden") ||
      gameStartCover.classList.contains("display") ||
      e.key === " " ||
      gameStatus === "pause"
    ) {
      return;
    ...
    switch (direction) {
      case "right":
        if (
          player.horizontalPosition < width - 1 &&
          !isElementInFacingDirection(player, "wall")
        )
          player.position++;
        break;
      case "left":
      ...
      case "down":
        if (
          player.verticalPosition < height - 1 &&
          !isElementInFacingDirection(player, "wall") &&
          !isElementInFacingDirection(player, "boundary")
        )
          player.position += width;
        break;
      default:
    ...
    if (
      outerCells[player.position].classList.contains("big_star") &&
      !player.display.classList.contains("flicker")
    ) {
    ...
    if (
      outerCells[player.position].classList.contains("blue_star") &&
      !player.display.classList.contains("flicker")
    ) {
  ...
  function printPosition() {
    ...
    cpuOnePositionDisplay.innerHTML = `cpuOne status:${
      cpuObjects[0].status
    } / cpuOne mood:${cpuObjects[0].mood.split("_")[0]} / cpuOne moodTimer:${
      cpuObjects[0].moodTimer
    } / cpuOne target:${cpuObjects[0].target} cpuOne speed:${
      cpuObjects[0].speed
    }  cpuMotion:${cpuObjects[0].motion}`;
